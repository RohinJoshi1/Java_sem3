...
class personal{
    ...
    void taxPay(personal p){
        ...
        if(sal<=250000){
            ...
            System.out.println("The tax to be paid is: "+(12500+0.1*(sal-500000)));
        }
        else if(sal>=750001 && sal<=1000000){
            System.out.println("The tax to be paid is: "+(37500+0.15*(sal-750000)));
        }
        else if(sal>=1000001 && sal<=1200000){
            System.out.println("The tax to be paid is: "+(75000+0.2*(sal-1000000)));
        }
        else if(sal>=12000001&& sal<=1500000){
            System.out.println("The tax to be paid is: "+(125000+0.25*(sal-12000000)));
        }
        
        
        else{
            System.out.println("The tax to be paid is: "+(180000+0.3*(sal-15000000)));
        }
    }
